...
#define SEPARATION_VERSION_MINOR 55
#define SEPARATION_VERSION       0.55
...
#define ENABLE_OPENCL SEPARATION_OPENCL
  ...
  #define SEPARATION_OPENCL_STR " OpenCL"
#else
  #define SEPARATION_OPENCL_STR ""
#endif
...
#define SEPARATION_APP_NAME "milkywayathome separation"
