    ...
    def move(self):
        for i in self.pop:
            ...
            if (i[0] < 1 or i[0] > 50) or (i[1] < 0.05 or i[1] > 1) or (i[2] < 1 or i[2] > 5) or (i[3] < 1 or i[3] > 5):
                        i[0],i[1],i[2],i[3] = uniform(1,50), uniform(0.05,1), uniform(1, 5), uniform(1,5), uniform(-1, 1), uniform(-0.01, 0.01), uniform(-0.1, 0.1), uniform(-0.1, 0.1),  0
...
def test():
    ...
    p = PSO(10, -4.5, 4.5, phi=0.3, phi2=0.3, lr=0.9, max_iter=1000000000, func=func)
